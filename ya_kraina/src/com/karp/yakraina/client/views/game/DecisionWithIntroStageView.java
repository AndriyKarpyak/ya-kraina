...
public class DecisionWithIntroStageView extends Composite {

	private static DecisionWithIntroStageViewUiBinder uiBinder = GWT.create(DecisionWithIntroStageViewUiBinder.class);

	interface DecisionWithIntroStageViewUiBinder extends UiBinder<Widget, DecisionWithIntroStageView> {
	}
	...
	public DecisionWithIntroStageView(DecisionStageJs stage) {
